...
public class View_LikeList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        likelist_adapter.addPoem(new Poem("아마도","임아두","아마도\n아마도\n사랑인가봐",true));
        likelist_adapter.addPoem(new Poem("현실","도혁대","현실에서\n꿈속에서\n너와 함께하고파",true));
        likelist_adapter.addPoem(new Poem("아무시","지아고","아무시나 일단 읊어\n아무거나 신통한 걸로\n아무렇게나 읊어\n아무렇지 않아 보이게",true));
        likelist_adapter.addPoem(new Poem("거대유성","김창모","전국 조선팔도 사람들이 말하네\n저 괴물체는 무엇인고\n거대유성... 거대유성...",true));
